...
2. Working Groups (participating more actively on a set topic)
3. Board (managing the organization) 
...
| Janitor (Board Member) | Drive and oversee operations, budget, editorial processes, and events |
| Treasurer (Board Member) | Oversight and reporting on any external grants or donations |

### Board 

The current board membership consists of:
